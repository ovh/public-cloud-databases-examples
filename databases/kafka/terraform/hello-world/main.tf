...
data "ovh_cloud_project_database_kafka_user_access" "access" {
  service_name = ovh_cloud_project_database_user.userjd.service_name
  cluster_id   = ovh_cloud_project_database_user.userjd.cluster_id
  user_id      = ovh_cloud_project_database_user.userjd.id
}
